...
import org.rust.wsl.sdk.add.RsAddWslSdkPanel
import javax.swing.JComponent

class RsEditWslSdkDialog(
    private val project: Project,
    existingSdks: List<Sdk>
) : RsEditRemoteSdkDialog, DialogWrapper(project, true) {
    private val panel: RsAddWslSdkPanel = RsAddWslSdkPanel(existingSdks)
